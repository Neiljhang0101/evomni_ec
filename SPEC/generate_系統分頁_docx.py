"""Convert 系統分頁管理 UX Spec markdown to DOCX for Claude Design upload."""
import re
import os
...
def process_md_to_docx(md_path, out_path, title, subtitle):
    ...
    sub_run.font.name = "Noto Sans TC"
...
if __name__ == "__main__":
    ...
    md = os.path.join(base, "系統分頁管理-UX-Spec.md")
    out = os.path.join(base, "系統分頁管理-UX-Spec.docx")
    process_md_to_docx(
        md,
        out,
        title="系統分頁管理",
        subtitle="Design Brief + UX Spec  |  Version: 1.0  |  Created: 2026-05-28  |  用途：上傳至 Claude Design，配合 Prompt Cheatsheet 使用",
    )
